...
<div class="box-body">
    <table id="example2" class="nobaar-table">
        ...
        <tbody>
        @foreach($conflict_orders as $key=>$order)
            <tr>
                ...
                <td>
                    <form action="{{route('orders.update',$order->id)}}" method="post" class="change_status">
                        ...
                        <select class="form-control" name="change_status"onchange="this.form.submit();">
                            <option value="1">ﺟﺪیﺩ</option>
                            <option selected value="">پﺫیﺭﻓﺖ ﺷﺪﻩ</option>
                            <option value="3">ﻥیاﺯﻣﻨﺪ ﻭیﺭایﺵ</option>
                            <option value="4">ﺷﺮﻭﻉ ﺑﺎﺭﺑﺮی</option>
                            <option value="5">پایاﻥ ﺑﺎﺭﺑﺮی</option>
                            <option value="6">ﺕکﻡیﻝ ﻓﺮایﻧﺪ</option>
                            <option value="7">ﻟﻐﻮ</option>
                        </select>
                    </form>
                </td>
                <td>
