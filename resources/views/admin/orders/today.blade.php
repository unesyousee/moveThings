<div class="box-body">
    <table class="nobaar-table">
        ...
        <tbody>
        @foreach($tody_orders as $key=>$order)
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#Modal{{$order->id}}today"><i class="fa fa-pencil"></i></button>
                    <div id="Modal{{$order->id}}today" class="modal fade" role="dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="/admin/orders/{{$order->id}}" method="post">
                                        ...
                                        <div class="form-group" style="display: flex;">
                                            <input id="order-data{{$order->id}}today"/>
                                            <input type="hidden" name="date" id="observe-alt{{$order->id}}today">
    ...
    {{$tody_orders->links()}}
        ...
        <script>
            setTimeout( function () {
                ...
                $('#order-data{{$order->id}}today').persianDatepicker({
                    observer: true,
                    altFormat: 'u',
                    initialValue: false,
                    minute : true,
                    format: 'YYYY-MM-DD',
                    altField: '#observe-alt{{$order->id}}today'
                });
                @endforeach
            },2000)
        </script>
